...
include_once("../../../_classes/paypal.class.php");
...
if($_POST) //Post Data received from product list page.
{
    ...
    foreach($_POST['item_name'] as $key=>$itmname)
    {
		...
		$results = $con->query("SELECT product_name, product_desc, price FROM exchange_products WHERE product_code='$product_code' LIMIT 1");
	...
	$padata = 	'&METHOD=SetExpressCheckout'.
				...
				'&LOGOIMG=http://www.blacknovadesigns.co.uk/images/pplogo.png'. //site logo
...
if(isset($_GET["token"]) && isset($_GET["PayerID"]))
{
    ...
    {		
        ...
        //total price
        $ItemTotalPrice = number_format($ItemTotalPrice + $subtotal, 2, '.', '');
    }
			...
			echo 'Your Transaction ID : '.urldecode($httpParsedResponseAr["PAYMENTINFO_0_TRANSACTIONID"]);
				...
				*/
				...
				if("SUCCESS" == strtoupper($httpParsedResponseAr["ACK"]) || "SUCCESSWITHWARNING" == strtoupper($httpParsedResponseAr["ACK"])) 
				{
					...
					$insert_row = $con->query("INSERT INTO exchange_buyers 
