...
$(document).ready(function(){//open popup$("#changelogs").click(function(){$("#logs").fadeIn(1000);positionPopup();}); //close popup$("#close").click(function(){$("#logs").fadeOut(500);});}); //position the popup at the center of the pagefunction positionPopup(){if(!$("#changelogs").is(':visible')){return;}$("#changelogs").css({left: ($(window).width() - $('#changelogs').width()) / 2,top: ($(window).width() - $('#changelogs').width()) / 7,position:'absolute'});} //maintain the popup at center of the page when browser resized$(window).bind('resize',positionPopup);