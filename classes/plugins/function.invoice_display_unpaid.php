 ...
 */
function smarty_function_invoice_display_unpaid() 
{
...
header("Location: " . $config_basedir . "admin/orders.php");
...
$orderssql = "SELECT * FROM exchange_orders WHERE status = 2";
...
echo "<table cellspacing=10><th>Preview</th><th>ID</td><th>Date and Time</th><th>Customer Name</th><th>Amount</th><th>Payment Method</th><th>Actions</th>";
